...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    Square s = make_square(new_clamp(file_of(ksq), FILE_B, FILE_G),
                           new_clamp(rank_of(ksq), RANK_2, RANK_7));
  ...
  Value Evaluation<T>::value() {
    ...
    Score score = pos.psq_score() + me->imbalance() + Threads.main()->contempt;
...
std::string Eval::trace(const Position& pos) {
  ...
  Threads.main()->contempt = SCORE_ZERO; // Reset any dynamic contempt
